...
public class CNNNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cnnnews);
    ...
    class fetchnews extends AsyncTask<Void,Void,String>
    {
        ...
        protected String doInBackground(Void... params) {
            try
            {
                URL url = new URL("https://newsapi  .org/v1/articles?source=cnn&sortBy=top&apiKey=53f79fdbd3bd4dd5a93300b7bf119417");
